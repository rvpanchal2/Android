...
import com.gracepad.hh.views.DividerItemDecoration;

import java.util.ArrayList;

public class ImpactMadeFragment extends Fragment {

    private static final String ARG_PARAM1 = "param1";

    // TODO: Rename and change types and number of parameters
    public static ImpactMadeFragment newInstance(ProfileObject object) {
        ImpactMadeFragment fragment = new ImpactMadeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_impact_made, container, false);

        act = getActivity();
        application = GracePadApplication.getInstance();
        objProfile = new StoreUserData().getUsers(act);

        refreshLayout = v.findViewById(R.id.refresh_Impact_Made);
        rvItem = v.findViewById(R.id.rv_Impact_Made);
        ...
        rvItem.addItemDecoration(new DividerItemDecoration(5));
