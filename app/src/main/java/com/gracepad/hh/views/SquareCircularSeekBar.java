...
public class SquareCircularSeekBar extends View {
    ...
    private static final float DEFAULT_POINTER_RADIUS = 6f;
    private static final float DEFAULT_POINTER_HALO_WIDTH = 5f;
    private static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 1f;
    private static final float DEFAULT_CIRCLE_STROKE_WIDTH = 4f;
    ...
    private void initPaints() {
        ...
        mCircleProgressGlowPaint.setMaskFilter(new BlurMaskFilter((15f * DPTOPX_SCALE), BlurMaskFilter.Blur.NORMAL));
//        mCircleProgressGlowPaint.setShadowLayer(10.0f, 0.0f, 1.0f, mCircleProgressColor);
...
//        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCircleHeight = (float)width / 2f - mCircleStrokeWidth - mPointerRadius - (mPointerHaloBorderWidth * 1.5f);
    ...
    public SquareCircularSeekBar(Context context) {
        super(context);
        init(null, 0);
    }

    public SquareCircularSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SquareCircularSeekBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnCircularSeekBarChangeListener {
        ...
        void onProgressChanged(SquareCircularSeekBar circularSeekBar, int progress, boolean fromUser);

        void onStopTrackingTouch(SquareCircularSeekBar seekBar);

        void onStartTrackingTouch(SquareCircularSeekBar seekBar);
    }
